...
import com.std.forum.dto.req.XN610045Reqt;
 ...
 * @history:
 */
public class XN610045t extends AProcessor {

    private IPostAO postAO = SpringContextHolder.getBean(IPostAO.class);

    private XN610045Reqt req = null;
    ...
    public void doCheck(String inputparams) throws ParaException {
        req = JsonUtil.json2Bean(inputparams, XN610045Reqt.class);
